...
const (
	ACache_Save_FullMethodName   = "/src.ACache/Save"
	ACache_Get_FullMethodName    = "/src.ACache/Get"
	ACache_Remove_FullMethodName = "/src.ACache/Remove"
)
...
func (c *aCacheClient) Save(ctx context.Context, in *Item, opts ...grpc.CallOption) (*Response, error) {
	...
	out := new(Response)
	err := c.cc.Invoke(ctx, ACache_Save_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCacheClient) Get(ctx context.Context, in *Key, opts ...grpc.CallOption) (*ItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, ACache_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aCacheClient) Remove(ctx context.Context, in *Key, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
	err := c.cc.Invoke(ctx, ACache_Remove_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedACacheServer must be embedded to have
...
func (UnimplementedACacheServer) testEmbeddedByValue()                {}
...
func RegisterACacheServer(s grpc.ServiceRegistrar, srv ACacheServer) {
	// If the following call panics, it indicates UnimplementedACacheServer was
...
func _ACache_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ACache_Save_FullMethodName,
	}
...
func _ACache_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ACache_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ACache_Remove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ACache_Remove_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
